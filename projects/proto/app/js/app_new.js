...
//var app = angular.module('app', ['ngRoute', 'ui.compat']);
...
//        $routeProvider.when('/surveys_list', {templateUrl: 'partials/surveys_list.html', controller: 'MyCtrl1'});
//        $routeProvider.when('/survey_edit', {templateUrl: 'partials/survey.html', controller: 'MyCtrl1'});
//        $routeProvider.when('/question_edit', {templateUrl: 'partials/question.html', controller: 'MyCtrl1'});
//        $routeProvider.when('/view2', {templateUrl: 'partials/partial2.html', controller: 'MyCtrl2'});
//        $routeProvider.otherwise({redirectTo: '/surveys_list'});
//    }]);
